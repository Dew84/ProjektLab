...
function SearchPage() {
  ...
  // URL paraméter változáskor (új keresés)
  useEffect(() => {
  ...
  useEffect(() => {
    loadAds();
  }, [searchQuery, appliedCategory, appliedMinPrice, appliedMaxPrice, appliedSortOption]);
  ...
  const loadAds = async () => {
    try {
      ...
      const params = {
        keyword: searchQuery, // Keresési kulcsszó
        pageSize: 1000,
      };
  ...
  return (
    <div className="search-page">
      <div className="search-header">
        ...
        <p>
          <strong>"{searchQuery}"</strong> kulcsszóra {ads.length} találat
        </p>
      </div>
          ...
          {(appliedCategory || appliedMinPrice || appliedMaxPrice || appliedSortOption !== 'newest') && (
            <div className="active-filters">
              ...
              {appliedSortOption !== 'newest' && (
                <span className="filter-tag">
                  {appliedSortOption === 'price-asc'
                    ? 'Ár ↑'
                    : appliedSortOption === 'price-desc'
                    ? 'Ár ↓'
                    : 'A-Z'}
                  <button
                    onClick={() => {
        ...
        <main className="search-content">
          {ads.length === 0 ? (
            <div className="no-ads-message">
              ...
              <p>Próbálj meg más kulcsszót vagy módosítsd a szűrőket!</p>
            </div>
          ) : (
            <>
