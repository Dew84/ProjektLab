...
export class UsersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param updateUserDto 
     */
    public async apiUsersMePut(updateUserDto?: UpdateUserDto, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class UsersApiResponseProcessor {
     ...
     */
     public async apiUsersGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<UserDto> >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async apiUsersIdGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<UserDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async apiUsersMeGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<UserDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: UserDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to apiUsersMePut
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async apiUsersMePutWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, undefined);
        }
