...
export class AuthApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param registerDto 
     */
    public async apiAuthRegisterPost(registerDto?: RegisterDto, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AuthApiResponseProcessor {
     ...
     */
     public async apiAuthLoginPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthResultDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: AuthResultDto = ObjectSerializer.deserialize(
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async apiAuthRegisterPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthResultDto >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
